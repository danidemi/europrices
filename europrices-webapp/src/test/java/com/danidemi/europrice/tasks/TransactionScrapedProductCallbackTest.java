...
public class TransactionScrapedProductCallbackTest {

	@Mock PlatformTransactionManager txManager;
	@Mock ScrapedProductCallback delegateCallback;
	TransactionStatus transaction;	
	ScrapedProduct item = new ScrapedProduct();
	
	@InjectMocks TransactionScrapedProductCallback tested = new TransactionScrapedProductCallback();
