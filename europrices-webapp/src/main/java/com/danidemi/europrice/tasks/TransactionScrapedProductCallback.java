...
import com.danidemi.europrice.pricegrabber.screenscraping.action.DelegateScrapedProductCallback;
 ...
 */
public class TransactionScrapedProductCallback extends DelegateScrapedProductCallback {

	private Logger log = LoggerFactory.getLogger(TransactionScrapedProductCallback.class);
