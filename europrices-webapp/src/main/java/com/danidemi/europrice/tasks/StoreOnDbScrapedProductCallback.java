...
public class StoreOnDbScrapedProductCallback implements ScrapedProductCallback {
	
	private Logger log = LoggerFactory.getLogger(StoreOnDbScrapedProductCallback.class);
